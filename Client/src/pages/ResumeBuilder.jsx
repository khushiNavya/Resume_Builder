...
const ResumeBuilder = () => {
  ...
  const sections = [
    ...
    { id: 'experience', name: "Experirnce", icon: Briefcase },
              ...
              <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
                ...
                <div className='flex items-center'>
                  {activeSectionIndex !== 0 && (
                    ...
                    transition-all' disabled={activeSection === 0}> <ChevronLeft className='size-4' />Previous</button>
                  )}
                  <button onClick={() => { setActiveSectionIndex((prevIndex) => Math.min(prevIndex + 1, sections.length - 1)) }} className={`flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 
                    ...
                    disabled={activeSection === sections.length - 1}>Next <ChevronRight className='size-4' /></button>
                </div>
              </div>
          ...
          <div className='lg:col-span-7 max-lg:mt-6'>
            ...
            <div className='relative w-full'>
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                ...
                <button onClick={downloadResume} className='flex items-center py-2 px-4 gap-2 text-xs bg-gradient-to-br from-green-100 to-green-200 text-green-600 ring-green-300 rounded-lg hover:ring transition-colors'>
